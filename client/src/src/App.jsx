...
function ResultPanel({ result, onFeedback, feedbackLoading }) {
    ...
    <div className="app-shell">
      <header className="topbar">
        <div className="brand-lockup">
          <img src={`${ASSET_BASE}/assets/banner.png`} alt="FakeBuster" />
          <div>
            <h1>FakeBuster</h1>
          ...
          <section className="tool-grid">
            <form className="text-panel" onSubmit={handlePredict}>
              ...
              <div className="form-actions">
                <button className="icon-button secondary" type="button" onClick={() => setText("")}>
                  <RefreshCw size={18} />
                  Clear
                </button>
